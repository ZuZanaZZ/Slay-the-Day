...
namespace ToDo.Controllers
{
    public class ToDoTasksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Done,task")] ToDoTask toDoTask)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Done,task")] ToDoTask toDoTask)
        {
            if (id != toDoTask.Id)
            {
                return NotFound();
